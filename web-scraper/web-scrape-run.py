...
root_urls = ["https://www.thewhiskyexchange.com/brands/scotchwhisky", "https://www.thewhiskyexchange.com/brands/worldwhisky"]

for link in root_urls:
    root_result = requests.get(link, headers={"User-Agent": "Mozilla/5.0"})
